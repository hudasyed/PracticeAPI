...
{
    public partial class test_apiContext : DbContext
    {
        ...
        public test_apiContext(DbContextOptions<test_apiContext> options) : base(options)
        {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer(@"Server=tcp:testapidb.database.windows.net,1433;Initial Catalog=test_api;Persist Security Info=False;User ID='testdb';Password='Testing!';MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BuildVersion>(entity =>
            {
                entity.HasKey(e => e.SystemInformationId)
                    .HasName("PK__BuildVer__35E58ECA533E1350");
